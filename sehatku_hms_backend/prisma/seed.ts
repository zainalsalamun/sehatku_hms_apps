  ...
  const doctors = [
    {
      ...
      phone: '0812-3456-7890',
      avatarUrl: '/public/doctors/dr_maya_pratama.jpg',
      availableToday: true,
      status: 'active',
    },
    {
      ...
      phone: '0813-9876-5432',
      avatarUrl: '/public/doctors/drg_rafi_akbar.jpg',
      availableToday: true,
      status: 'active',
    },
    {
      ...
      avatarUrl: '/public/doctors/dr_sarah_olivia.jpg',
    ...
    },
    {
      ...
      avatarUrl: '/public/doctors/dr_bima_santoso.jpg',
      availableToday: true,
      status: 'active',
    },
    {
      ...
      avatarUrl: '/public/doctors/dr_hendra_wijaya.jpg',
      availableToday: true,
      status: 'inactive',
    },
  ];
